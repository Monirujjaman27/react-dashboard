...
import { delData, StEaD } from '../../services/CategoryService';
...
export default class Category extends Component {
    ...
    getData = async () => {
        ...
        await axios.get(Routes.api.admin.category).then((res) => {
        ...
        this.columns = [
            ...
            },
            {
                ...
                cell: record => {
                    return (
                        <>
                            <Link to={`${Routes.web.admin.category}/edit/${record.id}`}
    ...
    render() {
        return (<div className="content-wrapper" >
            <Bradcrumb title={`Category`} />
            <section className="content p-0">
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12">
                            <Link to={Routes.web.admin.categoryCreate} className="btn btn-info btn-sm mb-2"> <i className="fas fa-plus"></i>  Add New</Link>
